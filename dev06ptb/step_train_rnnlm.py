...
def main(argv=None):
  ...
  train_file='fin.ptb.train.dat'
  valid_file='fin.ptb.valid.dat'

  train_data = process_data_lm(train_file, 'ptbdata', spId=False, input_index='input.wlist.index', output_index='input.wlist.index', bptt=20)
  valid_data = process_data_lm(valid_file, path="ptbdata", spId=False, input_index='input.wlist.index', output_index='input.wlist.index', bptt=None)
